  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-end">
        <Button size="sm" variant="outline" onClick={() => { setInput(""); setSeparator("-"); setMaxLength(0); setLowercase(true); }}>{t("clear")}</Button>
      </div>
      <div>
        <Label className="text-sm mb-1 block">{t("titleLabel")}</Label>
        <Input value={input} onChange={(e) => setInput(e.target.value)} placeholder={t("inputPlaceholder")} className="text-sm" />
      </div>
      <div className="flex flex-wrap items-end gap-4">
        <div>
          <Label className="text-xs mb-1 block">{t("separatorLabel")}</Label>
        ...
        <div>
          <Label className="text-xs mb-1 block">{t("maxLengthLabel")}</Label>
      ...
      <div>
        <Label className="text-sm mb-1 block">{t("slugLabel")}</Label>
